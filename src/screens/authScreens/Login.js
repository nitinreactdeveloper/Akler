...
const Content = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.contentScroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps={'handled'}>
            ...
            <View style={styles.rowAlign}>
                <View style={styles.checkboxContainer}>
                    <TouchableOpacity style={styles.checkbox} onPress={() => setIsSelected(!isSelected)}>
                        {isSelected ?
                            <MaterialIcons name='check' color="#539BEF" size={20}></MaterialIcons>
                            : null
                        }
                    </TouchableOpacity>
            ...
            <Text style={{ width: '100%', textAlign: 'center', color: '#000', fontSize: 16, fontWeight: '400', paddingBottom: 5 }}>OR</Text>
