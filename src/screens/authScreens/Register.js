    ...
    return (
        <ScrollView style={styles.contentScroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps={'always'}>
            ...
            <View style={{ display: 'flex', justifyContent: 'center', alignSelf: 'center', marginVertical: 10, marginBottom: 25 }}>
                <Text style={{
                    fontSize: 16, color: '#fff', fontWeight: '600', alignSelf: 'center', marginBottom: 3,
                    fontFamily: "Roboto-Bold",
                }}>Sign up to iforex </Text>
                <Text style={{
            ...
            <View style={styles.checkboxContainer}>
                <TouchableOpacity style={styles.checkbox} onPress={() => setIsSelected(!isSelected)}>
                    {isSelected ?
                        <MaterialIcons name='check' color="#18C5FC" size={20}></MaterialIcons>
                        : null
                    }
                </TouchableOpacity>
                <Text style={styles.solidBtnTxt2}>I accept the<Text style={[styles.solidBtnTxt2, { color: '#18C5FC', fontFamily: "Roboto-Bold", }]}> Terms & Conditions</Text></Text>
            </View>
            {errors.selected ?
            ...
            <TouchableOpacity style={[styles.solidBtn, styles.whiteBtn]}
                ...
                <Text style={[styles.solidBtnTxt2, { color: "#777" }]}>Already have an account?
                    <Text style={[styles.solidBtnTxt2, { color: '#18C5FC', fontFamily: "Roboto-Bold", }]}> Sign in</Text></Text>
            </TouchableOpacity>
        </ScrollView>
    )
}
